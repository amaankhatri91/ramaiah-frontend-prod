...
const EnquiryModal = dynamic(
  () => import("../../CommonComponets/EnquiryModal"),
  { ssr: false }
);
const AskExpertModal = dynamic(
  () => import("../../CommonComponets/AskExpertModal"),
  { ssr: false }
);
        ...
        <div className="flex flex-col sm:flex-row gap-3 md:gap-4 items-center">
          ...
          <div className="w-full sm:w-[20%] lg:mt-0 mt-2">
            <button
              ...
              className="cursor-pointer w-full rounded-full px-5 py-3 text-white Background-color focus:outline-none"
            >
              <span className="text-[16px] sm:text-[16px] md:text-[16px] lg:text-[16px]] text-[#ffffff] font-medium font-manrope">
                Ask Our Expert
              </span>
            </button>
          </div>
