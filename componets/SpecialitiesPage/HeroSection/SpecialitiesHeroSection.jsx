          ...
          <div className="relative z-10 grid md:grid-cols-2 gap-6 w-full container pb-[50px] pt-[25px]">
            <div className="flex items-center">
              <div className="min-[1200px]:p-6 rounded-lg">
                ...
                <h2 className={`min-[1480px]:text-[56px] min-[1200px]:text-[35px] min-[800px]:text-[26px] text-[22px] ${slug?.content_blocks[0]?.title === 'Ramaiah Institute of Oncosciences' ? 'min-[1200px]:leading-[44px] min-[1480px]:leading-[65px]' : ""}  font-bold Text-color2`}>
