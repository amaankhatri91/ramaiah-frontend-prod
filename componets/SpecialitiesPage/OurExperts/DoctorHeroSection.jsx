        ...
        >
          ...
          <div className="relative z-10 grid md:grid-cols-2 gap-6 w-full container pb-[50px] pt-[25px]">
            <div className="flex items-center">
              <div className="min-[1200px]:h-[600px] min-[800px]:h-[450px] h-[400px] bg-white border border-[#EFEFEF] shadow-md rounded-[24px] flex flex-col">
                {/* Scrollable content area */}
                <div className="flex-1 overflow-y-auto min-[1200px]:p-[24px] p-4">
                ...
                <div className="flex-shrink-0 p-4 bg-white border-t border-gray-100 rounded-b-[24px]">
