...
const ChronicPancreatitisPart2 = () => {
  return (
    <div>
      <div className="">
        {/* Grid 25/75 */}
        <div className="grid grid-cols-1 lg:grid-cols-12 items-stretch gap-6 mt-[16px]">
          ...
          <div className="lg:col-span-3 w-full h-full flex items-center">
            <Image
              src="/assets/ChronicPancreatitis2.svg"
              alt="Chronic Pancreatitis"
              width={800}
              height={800}
          ...
          <div className="lg:col-span-9 pr-2">
            <p className="text-[#3A3A3A] min-[1200px]:text-[18px] min-[800px]:text-[16px] text-[13px] min-[1200px]:mt-[24px] min-[1024px]mt-[16px] font-medium">
...
export default ChronicPancreatitisPart2;
