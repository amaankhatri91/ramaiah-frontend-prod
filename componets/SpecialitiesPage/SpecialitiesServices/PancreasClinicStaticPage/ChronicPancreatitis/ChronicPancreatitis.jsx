...
import ChronicPancreatitisPart2 from "./ChronicPancreatitisPart2";
import PatientEducation from "../PatientEducation/PatientEducation";
import HighRisk from "../HighRisk/HighRisk";
import PancreasClinic from "../PancreasClinic/PancreasClinic";
    ...
    <div className="">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 items-stretch gap-6 mt-[16px]">
        ...
        <div className="lg:col-span-3 order-1 lg:order-2 w-full h-full flex items-center">
          <Image
            src="/assets/ChronicPancreatitis1.svg"
        ...
        <div className="lg:col-span-9 order-2 lg:order-1 pr-2">
          <div className="min-[1345px]:text-[48px] min-[800px]:text-[40px] text-[22px] font-bold text-[#3D3D3D]">
            <h2>
              <span className="Text-color2">Chronic</span> Pancreatitis
            </h2>
          </div>
