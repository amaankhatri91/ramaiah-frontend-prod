    ...
    if (item.title === "Our Specialties" && hasChildren) {
      return (
        ...
        >
          ...
          >
            <button
              className={`transition-colors cursor-pointer font-manrope focus:outline-none min-[1190px]:px-[16px] px-[10px] min-[1190px]:text-[18px] font-medium text-[14px] py-[22px] rounded flex items-center gap-1 ${
      ...
      if (hasChildren) {
        ...
        return (
          <Link
            key={item.id}
            href={generateUrl(item)}
            className={`py-[22px] min-[1190px]:px-[16px] px-[10px] min-[1190px]:text-[18px] font-medium text-[14px] ${
              pathname === generateUrl(item)
                ? "Text-color font-bold"
                : "text-[#3D3D3D] hover:text-[#e14b8b]"
            }`}
        ...
        <div className="overflow-auto min-[1400px]:max-h-[600px] max-h-[500px]">
          {children.map((section, index) => (
            <div key={section.id}>
              ...
              <h4
                className={`text-[#3D3D3D] font-semibold ${
                  index > 0 ? "mt-5" : ""
                } mb-3`}
              >
                {section.title}
                      ...
                      >
                        <span className="flex gap-2 flex-1 text-left">
                          <Image
                            ...
                            width={18}
                            height={18}
                            className="w-[18px] h-[18px] min-[1200px]:mt-[3px]"
                          />
                          {center.title}
                        </span>
                        <Image
                          ...
                          height={7}
                          className={`${
                            openCenterKey === center.id ? "rotate-180" : ""
                          }`}
                        />
                      </Link>
                      {openCenterKey === center.id &&
                        center.children &&
                      ...
                      {item.children && item.children.length > 0 ? (
                        ...
                        >
                          ...
                          <Image
                            ...
                            height={7}
                            className={`${
                              (section.title === "Other Super Specialties" &&
                                openOtherSlug === item.id) ||
                              (section.title === "Broad Specialties" &&
                                openBroadSlug === item.id)
                                ? "rotate-180"
                                : ""
                            }`}
                          />
                                  ...
                                  <button
                                    ...
                                    onClick={() => {
                                      if (
                                        ...
                                        setOpenOtherChildSlug((s) =>
                                          s === child.id ? null : child.id
                                        );
                                      } else {
                                        const parentPath =
      ...
      {isSearchOpen && (
        ...
        >
          <div className="container flex justify-end">
            <div
              className="mt-[23vh] w-[90%] max-w-[620px] cursor-pointer"
