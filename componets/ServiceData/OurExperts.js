        ...
        Doctor: [
          {
            ...
            fellowships: [
              'ESMOrrr Travelling Fellowship – Hemato-oncology and transplant medicine',
              'ACORD Fellowship – Clinical research methodology in oncology',
              'Advanced training in stem cell transplantation techniques',
              'Clinical Fellowship in hematologic malignancies',
              'Workshops and CME in transplant nutrition and supportive care',
            ],
            awards: [
              'Research Excellence Award – Ramaiah Medical College',
              'Member – National Academy of Medical Sciences, New Delhi',
              'Teaching Excellence recognition for postgraduate training',
              'Invited speaker at ASH, ASCO, and ESMO',
              'Reviewer – Indian Journal of Surgical Oncology, Cancer Reports',
            ],
            experience: [
              '15+ years in Medical Oncology and Bone Marrow Transplant',
              'Autologous and allogeneic stem cell transplants',
              'Management of acute leukemia, multiple myeloma, and lymphomas',
              'Multidisciplinary cancer care and tumor boards',
              'Clinical research and protocol development',
              'Mentoring residents and fellows in oncology',
            ],
            memberships: [
              'Member, Bangalore Hematology Group (2016)',
              'Member, Association of Medical Oncologists of India (2016)',
              'Life Member, Indian Society of Medical & Pediatric Oncology (2015)',
              'Member, European Society of Medical Oncology (2014)',
              'Member, American Society of Hematology (2017)',
              'Member, American Society of Clinical Oncology (2022)',
            ],
            blogs: [
              {
                date: '2025-05-01',
                title: 'Optimizing outcomes in acute leukemia: current transplant strategies',
                description: 'Discussion on risk-adapted transplant approaches and supportive care to improve survival and quality of life.',
                doctor: 'Dr Santhosh Devadas, HOD & Consultant – Medical Oncology',
                link: '#',
              },
              {
                date: '2025-05-12',
                title: 'Nutrition in stem cell transplantation: what patients should know',
                description: 'Key principles of nutritional management before and after transplant to reduce complications.',
                doctor: 'Dr Santhosh Devadas, HOD & Consultant – Medical Oncology',
                link: '#',
              },
              {
    ...
    Doctor: [
      {
        ...
        qualification: "Anesthesiology MBBS DA DNB PGDHHM",
      ...
      },
      {
        ...
        designation: "Consultant",
        specialty: "Anesthesiology",
        qualification: "Consultant MBBS MD DRA PGDHHM",
  ...
  },
  {
    ...
    Doctor: [
      ...
      },
      {
        ...
        designation: "Consultant",
        specialty: "Anesthesiology",
        qualification: "Anesthesiology MBBS MD DRA PGDHHM",
        image: "/assets/dr2.svg",
      },
      {
        id: 3,
        ...
        designation: "Consultant",
        specialty: "Anesthesiology",
        qualification: " Anesthesiology MBBS MD",
        image: "/assets/dr3.svg",
      },
      {
        id: 4,
        ...
        designation: "Consultant",
        specialty: "Anesthesiology",
        qualification: "Anesthesiology MBBS. DA. PGDHHM",
        image: "/assets/dr4.svg",
      },
      {
        id: 5,
        ...
        designation: "Director — Cardiac Sciences ",
        specialty: "Anesthesiology",
        qualification: "Anesthesiology DM (Cardiology). MD (Medicine),MBBS",
        image: "/assets/dr3.svg",
      },
      {
        id: 6,
    ...
    Doctor: [
      {
        ...
        designation: "Consultant",
        specialty: "Anesthesiology",
        qualification: "Anesthesiology MBBS DA",
        image: "/assets/dr1.svg",
      },
      {
        id: 2,
    ...
    Doctor: [
      {
        ...
        qualification:
          "Director — Cardiac Sciences DM (Cardiology). MD (Medicine),MBBS",
        image: "/assets/dr1.svg",
      },
      {
        id: 2,
    ...
    Doctor: [
      {
        ...
        specialty: "",
        qualification:
          "Critical Care Medicine MBBS, MO, FRCP, EDIC, FCCM, FCCP",
        image: "/assets/dr1.svg",
      },
      {
        id: 2,
